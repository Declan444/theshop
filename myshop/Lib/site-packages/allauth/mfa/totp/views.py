...
class ActivateTOTPView(FormView):
    ...
    template_name = (
        "mfa/totp/activate_form." + account_settings.TEMPLATE_EXTENSION
    )
    ...
    def get_form_class(self):
        return get_form_class(
            app_settings.FORMS, "activate_totp", self.form_class
        )
...
class DeactivateTOTPView(FormView):
    ...
    template_name = (
        "mfa/totp/deactivate_form." + account_settings.TEMPLATE_EXTENSION
    )
    ...
    def get_form_class(self):
        return get_form_class(
            app_settings.FORMS, "deactivate_totp", self.form_class
        )
