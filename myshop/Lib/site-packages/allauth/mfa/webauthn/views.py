...
class AddWebAuthnView(FormView):
    ...
    template_name = (
        "mfa/webauthn/add_form." + account_settings.TEMPLATE_EXTENSION
    )
...
class ListWebAuthnView(ListView):
    template_name = (
        "mfa/webauthn/authenticator_list."
...
class LoginWebAuthnView(RedirectAuthenticatedUserMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        return flows.perform_passwordless_login(
...
class ReauthenticateWebAuthnView(BaseReauthenticateView):
    ...
    template_name = (
        "mfa/webauthn/reauthenticate." + account_settings.TEMPLATE_EXTENSION
    )
...
class EditWebAuthnView(NextRedirectMixin, UpdateView):
    ...
    template_name = (
        "mfa/webauthn/edit_form." + account_settings.TEMPLATE_EXTENSION
    )
    success_url = reverse_lazy("mfa_list_webauthn")
...
class SignupWebAuthnView(FormView):
    ...
    template_name = (
        "mfa/webauthn/signup_form." + account_settings.TEMPLATE_EXTENSION
    )
