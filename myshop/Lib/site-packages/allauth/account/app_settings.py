...
class AppSettings:
    ...
    def __init__(self, prefix):
        ...
        if self.CHANGE_EMAIL:
            if (
                self.MAX_EMAIL_ADDRESSES is not None
                and self.MAX_EMAIL_ADDRESSES != 2
            ):
    ...
    def SIGNUP_REDIRECT_URL(self):
        ...
        return self._setting(
            "SIGNUP_REDIRECT_URL", settings.LOGIN_REDIRECT_URL
        )
    ...
    def RATE_LIMITS(self):
        ...
        if attempts_amount and attempts_timeout:
            login_failed_rl = (
                f"10/m/ip,{attempts_amount}/{attempts_timeout}s/key"
            )
    ...
    def LOGOUT_REDIRECT_URL(self):
        ...
        return self._setting(
            "LOGOUT_REDIRECT_URL", settings.LOGOUT_REDIRECT_URL or "/"
        )
