...
def test_user_email_domain_unicode_collision(
    settings, rf, user_factory, mailoutbox
):
    settings.ACCOUNT_PREVENT_ENUMERATION = False
...
def test_user_email_domain_unicode_collision_nonexistent(
    settings, user_factory
):
    settings.ACCOUNT_PREVENT_ENUMERATION = False
    user_factory(username="mike123", email="mike@ixample.org")
    data = {"email": "mike@ıxample.org"}
