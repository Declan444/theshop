...
# Type aliases
_NestedStr: TypeAlias = Union[
    str, Iterable[Union[str, Iterable["_NestedStr"]]]
]
...
_ResourceStream: TypeAlias = (
    Any  # TODO / Incomplete: A readable file-like object
)
...
class WorkingSet:
    ...
    def resolve(
        ...
        env: Environment | None = None,
        installer: (
            _InstallerType | None | _StrictInstallerType[_DistributionT]
        ) = None,
        replace_conflicting: bool = False,
        extras: tuple[str, ...] | None = None,
...
def fixup_namespace_packages(
    path_item: str, parent: str | None = None
) -> None:
...
class Distribution:
    ...
    def activate(
        self, path: list[str] | None = None, replace: bool = False
    ) -> None:
