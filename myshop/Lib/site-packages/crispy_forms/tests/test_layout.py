...
def test_second_layout_multifield_column_buttonholder_submit_div():
    ...
    c = Context(
        {"form": SampleForm(), "form_helper": form_helper, "value_var": "Save"}
    )
    html = template.render(c)
...
@pytest.mark.parametrize(
    ...
    [
        (
            True,
            "bootstrap4/test_layout/test_use_custom_control_in_select_true.html",
        ),
        (
            False,
            "bootstrap4/test_layout/test_use_custom_control_in_select_false.html",
        ),
    ],
)
