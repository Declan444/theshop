...
class ResourceFromZipsTest01(util.ZipSetupBase, unittest.TestCase):
    ...
    def test_is_submodule_resource(self):
        ...
        self.assertTrue(
            resources.files(submodule).joinpath("binary.file").is_file()
        )

    def test_read_submodule_resource_by_name(self):
        self.assertTrue(
            resources.files("data01.subdirectory")
...
class DeletingZipsTest(util.ZipSetupBase, unittest.TestCase):
    ...
    def test_entered_path_does_not_keep_open(self):
        ...
        """
        resources.as_file(
            resources.files("data01") / "binary.file"
        ).__enter__()
    ...
    def test_read_text_does_not_keep_open(self):
        resources.files("data01").joinpath("utf-8.file").read_text(
            encoding="utf-8"
        )
...
class ResourceFromNamespaceTests:
    ...
    def test_submodule_contents(self):
        ...
        self.assertEqual(
            contents,
            {"subdirectory", "binary.file", "utf-8.file", "utf-16.file"},
        )
    ...
    def test_submodule_sub_contents(self):
        contents = names(
            resources.files(import_module("namespacedata01.subdirectory"))
        )
        try:
            contents.remove("__pycache__")
        except KeyError:
...
class ResourceFromNamespaceDiskTests(
    ResourceFromNamespaceTests, unittest.TestCase
):
