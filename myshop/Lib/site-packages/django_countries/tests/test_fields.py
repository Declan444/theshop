...
class TestCountryField(TestCase):
    ...
    def test_custom_field_str_attr(self):
        person = Person(
            name="Quentin Coumes", country="FR", str_attr_country="ES"
        )
    ...
    def test_COUNTRIES_FLAG_URL_setting(self):
        ...
        person = Person(name="Chris Beaven", country="NZ")
        with self.settings(
            COUNTRIES_FLAG_URL="img/flag-{code_upper}.png",
...
def test_longer_country_code_multiple_deconstruction():
    field = CountryField(
        countries=custom_countries.GBRegionCountries, multiple=True
    )
    expected_max_length = (
        # Commas
...
class TestCountryObject(TestCase):
    ...
    def test_extensions(self):
        with mock.patch.object(
            fields, "EXTENSIONS", {"codex2": lambda c: c.code * 2}
        ):
            country = fields.Country(code="NZ")
