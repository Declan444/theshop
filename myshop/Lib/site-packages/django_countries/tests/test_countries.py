...
class TestCountriesObject(BaseTest):
    ...
    def test_ioc_code_override(self):
        with self.settings(
            ...
            self.assertEqual(
                countries.ioc_code("US"),
                "XXX",
                "Should use provided custom IOC code",
            )
            self.assertEqual(
...
class CountriesFirstTest(BaseTest):
    ...
    def test_countries_first_no_valid(self):
        with self.settings(
            COUNTRIES_FIRST=["XX"], COUNTRIES_FIRST_BREAK="------"
        ):
            countries_list = list(countries)
    ...
    def test_countries_first_repeat(self):
        with self.settings(
            COUNTRIES_FIRST=["NZ", "AU"], COUNTRIES_FIRST_REPEAT=True
        ):
            countries_list = list(countries)
    ...
    def test_translation_fallback_no_override(self):
        ...
        try:
            ...
            with self.settings(
                COUNTRIES_OVERRIDE={"NZ": "Hobbiton", "YE": "YYemen"}
            ):
                del countries.countries
