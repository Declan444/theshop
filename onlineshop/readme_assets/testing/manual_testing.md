...
| Shop Now Link | Directed to Products page | Clicked Shop Now link | Products page displayed | &check; | Declan |
| Weekly Bargain/Shop Now Link | Directed to Products/Weekly Bargain page | Clicked Weekly Bargain/Shop Now link | Products/Weekly Bargain page displayed | &check; | Declan |
| All Products Link | Directed to home page | Clicked home menu link | Home page displayed | &check; | Declan |
| Lessons Menu link | Displays a dropdown menu | Clicked All Products Lik | Dropmenu appeared | &check; | Declan |
| Horseware Link | Displays a dropdown menu | Clicked Horseware link | Dropmenu appeared | &check; | Declan |
| Riderware Link | Displays a dropdown menu | Clicked Riderware link | Dropmenu appeared | &check; | Declan |
| Special Offers Link | Displays a dropdown menu | Clicked Special Offers link | Dropmenu appeared | &check; | Declan |
| Reviews Link | Displays a dropdown menu | Clicked Reviews link | Dropmenu appeared | &check; | Declan |
| Contact Us Link | Directed to contact us page | Clicked Contact Us link | Contact Us page displayed | &check; | Declan |
| My Account Link | Displays a dropdown menu | My Account link | Dropmenu appeared | &check; | Declan |
| Shopping Bag Link | Directed to shopping bag page | Clicked Shopping Bag link | Shopping page displayed | &check; | Declan |
| Search Our Site Field | Ability to enter text | Clicked Search oUr site Field | Able to enter text | &check; | Declan |
| All Products By Price link | Directed to Products page | Clicked All Products by Price link | Products page displayed | &check; | Declan |
| All Products By Rating link | Directed to Products page | Clicked All Products by Rating link | Products page displayed | &check; | Declan |
| All Products By Category link | Directed to Products page | Clicked All Products by Category link | Products page displayed | &check; | Declan |
| All Products All Products link | Directed to Products page | Clicked All Products All Products link | Products page displayed | &check; | Declan |
| Horsewear/Saddles link | Directed to Products with Saddles page | Clicked All Horseware/Saddles link | Products page displayed with Saddles | &check; | Declan |
| Horsewear/Bridles link | Directed to Products with Bridles page | Clicked All Horseware/Bridles link | Products page displayed with Bridles | &check; | Declan |
| Horsewear/Covers link | Directed to Products with Covers page | Clicked All Horseware/Covers link | Products page displayed with Covers | &check; | Declan |
| Horsewear/Extras link | Directed to Products with Extras page | Clicked All Horseware/Extras link | Products page displayed with Extras | &check; | Declan |
| Riderware/Helmets link | Directed to Products with Helmets page | Clicked All Riderware/Helmets link | Products page displayed with Helmets | &check; | Declan |
| Riderware/Jackets link | Directed to Products with Jackets page | Clicked All Riderware/Jackets link | Products page displayed with Jackets | &check; | Declan |
| Riderware/Boots link | Directed to Products with Boots page | Clicked All Riderware/Boots link | Products page displayed with Boots | &check; | Declan |
| Special Offers/New Products link | Directed to Products with New Products page | Clicked All Special Offers/New Products link | Products page displayed with New Products | &check; | Declan |
| Special Offers/Deals link | Directed to Products with New Products page | Clicked All Special Offers/Deals link | Products page displayed with Deals | &check; | Declan |
| Special Offers/Clearance link | Directed to Products with Clearance page | Clicked All Special Offers/Clearance link | Products page displayed with Clearance | &check; | Declan |
| Reviews/View Reviews link | Directed to User Reviews page | Clicked Reviews/View Reviews link | User Reviews Page with reiews | &check; | Declan |
| Reviews/Leave a Review link | Directed to Sign In Page page | Clicked Reviews/Leave a Review link | Sign In Page | &check; | Declan |
| My Account/Register link | Directed to Sign Up Page page | Clicked Account/Register link | Sign Up Page | &check; | Declan |
| My Account/Login link | Directed to Sign In Page page | Clicked Account/Login link | Sign In Page | &check; | Declan |
| **Footer** |
| Facebook link | Directed to Facebook Page | Clicked Facebook link | Directed to Facebook Page | &check; | Declan |
| Linkedln link | Not active | Clicked Linkedln link | Directed to Home Page | &check; | Declan |
